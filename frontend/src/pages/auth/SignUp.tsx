    ...
    <SignUp
      appearance={{
        elements: {
          ...
          formFieldInput: 
            'bg-white border border-gray-200 dark:border-gray-700 focus:border-yellow-500 dark:focus:border-yellow-500 focus:ring-4 focus:ring-yellow-500/20 dark:bg-gray-50 dark:focus:ring-yellow-500/20 rounded-xl transition-all duration-200',
          footerActionLink: 
