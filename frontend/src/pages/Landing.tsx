...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 relative overflow-hidden transition-colors duration-200">
      ...
      >
        <div
          className={`max-w-7xl mx-auto px-4 lg:px-8 transition-all duration-300 ${
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              ...
              />
              <span
                className={`font-bold text-black dark:text-white transition-all duration-300 ${
              ...
              >
                {isAuthenticated() ? (
                  ...
                  <>
                    ...
                    <motion.button onClick={() => navigate("/sign-up")}>
                      Sign Up
                    </motion.button>
                  </>
                )}
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative mt-20">
        <div className="max-w-7xl mx-auto ">
          ...
          >
            ...
            >
              A data-driven initiative enhancing behavioral health insights and
              healthcare practices in Alaska through a federated data approach.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              <div className="max-w-[1400px] mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  <div className="relative">
                    ...
                    >
                      Transforming healthcare data into actionable insights, one
                      decision at a time.
                    </motion.blockquote>
                    <motion.div
                      initial={{ y: 20, opacity: 0 }}
                  ...
                  >
                    <Card className="p-8 bg-gradient-to-br from-gray-900 to-black">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        ...
                        user management, and data visualization tools. Monitor
                        system performance and manage permissions with ease.
                      </p>
                    </Card>
                    ...
                    <Card className="p-8 bg-gradient-to-br from-gray-900 to-black">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        Clean and user-friendly dashboard for healthcare
                        providers. Access patient data, generate reports, and
                    ...
                    <Card className="p-8 bg-gradient-to-br from-gray-900 to-black">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        ...
                        Transform complex healthcare data into actionable
                        insights with interactive charts and reports.
                      </p>
                    </Card>
                  </CardSwap>
                </div>
          ...
          <div id="features" className="max-w-7xl mx-auto mt-10 ">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Discover how Beehive is revolutionizing behavioral health data
            ...
            {[
              {
                ...
                description:
                  "Secure and efficient sharing of behavioral health data across Alaska",
                icon: "📊",
              },
              {
                title: "Healthcare Insights",
                description:
                  "Advanced analytics for better healthcare decision making",
                icon: "🏥",
              },
              {
                title: "Community Impact",
                description:
                  "Improving behavioral health outcomes for Alaskans",
                icon: "🤝",
              },
            ].map((feature, index) => (
              <Spotlightcard
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-300">
                <p className="text-lg">
                  At Beehive, we're committed to transforming behavioral
                  healthcare in Alaska through innovative data solutions and
                  collaborative approaches.
                </p>
                <p className="text-lg">
                  Our platform enables healthcare providers to make data-driven
            ...
            {[
              {
                ...
                description:
                  "UAA College of Engineering, 3211 Providence Drive, ECB 308G, Anchorage, AK 99508.",
                icon: "📍",
              },
              {
                title: "Email Us",
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                key={index}
                className="flex flex-col items-center text-center p-6 bg-white dark:bg-gray-700 rounded-lg shadow-sm hover:shadow-md transition-shadow"
                whileHover={{ x: 5 }}
              >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-400">
              Transforming behavioral healthcare through data-driven insights.
            </p>
          </motion.div>
          ...
          {[
            ...
            },
            {
              ...
              links: [
                ...
                {
                  name: "GitHub",
                  href: "https://github.com/kathiravelulab/beehive",
                },
              ],
            },
          ].map((section, index) => (
